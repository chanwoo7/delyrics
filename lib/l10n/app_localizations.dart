...
abstract class AppLocalizations {
  ...
  /// No description provided for @statusInput.
  ///
  /// In en, this message translates to:
  /// **'Input'**
  String get statusInput;

  /// No description provided for @statusOutput.
  ///
  /// In en, this message translates to:
  /// **'Output'**
  String get statusOutput;

  /// No description provided for @statusDeduplicated.
  ///
  /// In en, this message translates to:
  /// **'Deduplicated'**
  String get statusDeduplicated;
  ...
  /// No description provided for @deduplicatedResult.
  ///
  /// In en, this message translates to:
  /// **'Deduplicated Result'**
  String get deduplicatedResult;
  ...
  ///
  /// In en, this message translates to:
  /// **'Only .txt and .lrc files are supported'**
